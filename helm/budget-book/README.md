...
| image.repository | string | `"ghcr.io/steled/budget-book"` | Image repository |
...
| networking.gateway.hostname | string | `"budget-book.tools.example.lan"` | Hostname exposed via the HTTPRoute |
